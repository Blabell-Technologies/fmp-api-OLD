...
router.get('/:animal/check', (req, res) => { 
  ...
  res.status(200).json({ code: 200, details: { exist: animal_exist } })
})
...
router.get('/:animal/races', (req, res) => {
  ...
  res.status(200).json({ code: 200, details: { races: animal_races } })
})
...
router.get('/:animal/races/:race/check', (req, res) => { 
  ...
  res.status(200).json({ code: 200, details: { exist: race_exist } });
})
